...
import com.tvd.cocos2dx.popup.creator.model.basic.Point;
import com.tvd.cocos2dx.popup.creator.model.basic.Size;
...
//		    mSize = new Size(width, height);
	...
	public String createWidgetsTag(String pId, String pImagePath) throws IOException {
		...
		builder.append("<widgets xsi:type=\"model:Image\" ")
			...
			.append("measuredWidth=\"" + width + "\" ")
			.append("measuredHeight=\"" + height + "\" ")
			.append("src=\"assets/" + imageDirectory + "/" + mRealPath + "\" ")
			.append("/>\n");
		return builder.toString();
	}
	
	public void fetchSize(String physicalPath, float scaleFactor) {
