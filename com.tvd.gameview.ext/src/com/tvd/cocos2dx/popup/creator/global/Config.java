...
package com.tvd.cocos2dx.popup.creator.global;
...
import com.tvd.cocos2dx.popup.creator.model.Resource;
...
public class Config {
	...
	public void loadConfigs() {
		...
		mDefaultScreenSizes = fileUtils.fetchDefaultKeyValues(
				"Screen size", fileContent);
		mDefaultScaleFactors = fileUtils.fetchDefaultKeyValues(
				"Scale factor", fileContent);
	...
	public String getDefaultScreenSizeString(String device) {
		return getDefaultValue(mDefaultScreenSizes, device, "320, 480");
	}
	
	public float getDefaultScaleFactor(String device) {
		String scaleStr = getDefaultValue(mDefaultScaleFactors, device, "2");
	...
	private Map<String, String> mDefaultScreenSizes;
	private Map<String, String> mDefaultScaleFactors;
