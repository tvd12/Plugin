...
public class XmlFileParser_1_0 extends DefaultHandler {
	...
	public void startElement(String namespaceURI, String localName,
		...
		if(qName.equals(Tag.VIEW)) {
			...
			label.setFontSizeVar(getAttributeValue(Attribute.S_VALUE, atts));
		}
	...
	public void endElement(String namespaceURI, String localName, 
		...
		if(qName.equals(Tag.DEFINE_PATH)) {
			...
			((Label)mCurrentObject).setFontName(mCurrentText);
		}
		else if(qName.equals(Tag.FONT_SIZE)) {
