...
import com.tvd.cocos2dx.popup.creator.file.FileParser;
import com.tvd.cocos2dx.popup.creator.global.Config;
import com.tvd.cocos2dx.popup.creator.model.AdvancedCell;
...
public class XmlViewCreator {
	...
	public XmlViewCreator(String pInputPath, String pDevice) {
		...
		this.setScaleFactor(Config.getInstance().getDefaultScaleFactor(pDevice));
	}
